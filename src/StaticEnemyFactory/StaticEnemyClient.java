...
public class StaticEnemyClient {
    ...
    /*
        ...
        times to create an ArrayList of StaticEnemy objects, that will be used
    ...
    public StaticEnemyClient(TiledMap map) {
        this.map = map;
    ...
    public ArrayList<StaticEnemy> getStaticEnemies() {
        ...
        ArrayList<StaticEnemy> staticDamageArray = new ArrayList<>();
