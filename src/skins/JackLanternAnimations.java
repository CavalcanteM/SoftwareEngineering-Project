...
public class JackLanternAnimations extends BasicAnimations {
    ...
    public JackLanternAnimations(int runAnimationLength, int idleAnimationLength, int deathAnimationLength){
    ...
    public void createAnimations() throws SlickException{
        ...
        for(int i=0; i<frames.length; i++)
        {
            ...
            frames[i] = new Image("./graphics/jack/Run (" + (i+1) + ").png").getScaledCopy(WIDTH, HEIGHT);  
        ...
        for(int i=0; i<frames.length; i++) 
        {
            ...
            frames[i] = new Image("./graphics/jack/Idle (" + (i+1) + ").png").getScaledCopy(WIDTH, HEIGHT);
        ...
        for(int i = 0; i < frames.length; i++)
        {
            ...
            frames[i] = new Image("./graphics/jack/Dead (" + (i+1) + ").png").getScaledCopy(WIDTH, HEIGHT);
