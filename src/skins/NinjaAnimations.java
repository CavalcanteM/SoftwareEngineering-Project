...
public class NinjaAnimations extends BasicAnimations{
    ...
    public void createAnimations() throws SlickException{
        ...
        for(int i=0; i<frames.length; i++)
        {
            ...
            frames[i] = new Image("./graphics/ninja/Run__00" + i + ".png").getScaledCopy(WIDTH, HEIGHT);  
        ...
        for(int i=0; i<frames.length; i++) 
        {
            ...
            frames[i] = new Image("./graphics/ninja/Idle__00" + i + ".png").getScaledCopy(WIDTH, HEIGHT);
        ...
        for(int i = 0; i < frames.length; i++)
        {
            ...
            frames[i] = new Image("./graphics/ninja/Dead__00" + i + ".png").getScaledCopy(WIDTH, HEIGHT);
