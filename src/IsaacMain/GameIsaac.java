...
public class GameIsaac extends BasicGameState {
    ...
    public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
        ...
        Button options = new Button(50, 150, new ChangeControls(), "Settings");
    ...
    public void initLevelList() {
        ...
        if (this.galaxy == null) {
            ...
            GalaxyComponent level2 = new Level("Level 1-2", 5, 2, 1);
            GalaxyComponent level3 = new Level("Level 1-3", 5, 3, 1);
            GalaxyComponent level4 = new Level("Level 1-4", 5, 4, 1);
            world1.add(level1);
            world1.add(level2);
            world1.add(level3);
            world1.add(level4);
            ...
            GalaxyComponent level5 = new Level("Level 2-1", 5, 5, 4);
            GalaxyComponent level6 = new Level("Level 2-2", 5, 6, 4);
            GalaxyComponent level7 = new Level("Level 2-3", 5, 7, 4);
            GalaxyComponent level8 = new Level("Level 2-4", 5, 8, 4);
            world2.add(level5);
            world2.add(level6);
            world2.add(level7);
            world2.add(level8);
            ...
            GalaxyComponent level9 = new Level("Level 3-1", 5, 9, 7);
            GalaxyComponent level10 = new Level("Level 3-2", 5, 10, 7);
            GalaxyComponent level11 = new Level("Level 3-3", 5, 11, 7);
            GalaxyComponent level12 = new Level("Level 3-4", 5, 12, 7);
            world3.add(level9);
            world3.add(level10);
            world3.add(level11);
            world3.add(level12);
            ...
            GalaxyComponent level13 = new Level("Level 4-1", 5, 13, 10);
            GalaxyComponent level14 = new Level("Level 4-2", 5, 14, 10);
            GalaxyComponent level15 = new Level("Level 4-3", 5, 15, 10);
            GalaxyComponent level16 = new Level("Level 4-4", 5, 16, 10);
            world4.add(level13);
            world4.add(level14);
            world4.add(level15);
            world4.add(level16);
